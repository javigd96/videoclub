        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form class="w-full max-w-lg border-4" method="POST" action="{{ $route }}" enctype="multipart/form-data">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">{{ __("Escribe tu pelicula") }}</h2>
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ old('year') ?? $film->year }}" name="year" type="number" id="year"
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ old('poster') ?? $film->poster }}" name="poster" type="file" id="poster"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                    ...
                    <button type="submit" class="text-white bg-indigo-500 border-0 py-2
                     px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">{{ $textButton }}</button>
